...
//Main Functionallity
  ...
  Total := Food_Price + Drinks_Price + Sweets_Price ;
  ShowMessage(IntToStr(Total)) ;

  edtFoodPrice.Text := IntToStr(Food_Price) ;
  edtDrinkPrice.Text := IntToStr(Drinks_Price) ;
  edtSweetPrice.Text := IntToStr(Sweets_Price) ;
